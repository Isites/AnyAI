...
func (t *BrowserTool) ToolMetadata() ToolMetadata {
	return readOnlyToolMetadata(t.Name(), browserToolTimeoutMS)
}

func (t *BrowserTool) TimeoutHintForInput(input json.RawMessage, fallback time.Duration) (time.Duration, bool) {
	var in browserInput
